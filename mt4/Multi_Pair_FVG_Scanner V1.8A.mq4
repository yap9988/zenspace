...
//v1.8 get daily kama value & change the arrow definition (V^) in the message
    ...
    else
    {
      ...
      stt=stt1+stt2;
       ...
       //  string messageAlert=symbol+" FVG "+pType+". "+firstc+": "+firstS[symbolIndex][0]+st1+", "+lastc+": "+secondS[symbolIndex][0]+st2+". "+"Score: "+stt+". V: "+power+". "; last known good config
          ...
          string messageAlert=symbol+pType+"(15M,C)"+"D: "+pTypeD+"|S:"+stt+"|"+firstc+":"+firstS[symbolIndex][0]+st1+","+lastc+":"+secondS[symbolIndex][0]+st2+"|V:"+power;
...
void calculatekama(ENUM_TIMEFRAMES timeFrame,double &FVGArrayRef[][],int symbolIndex,string symbolName)
 {
   ...
   int nearestFVG3 = -1, nearestFVG4 = -1;
    ...
    //7 ExtUpFractalsBuffer[1] == Low[1]
     kama1=iCustom(symbolName,PERIOD_D1,"Limaocanfly\\KAMA V1.6",7,1);
     kama2=iCustom(symbolName,PERIOD_D1,"Limaocanfly\\KAMA V1.6",8,1);
  ...
  /*  if ( iClose(symbolName, PERIOD_M15, 1)> FVG2)
     {
       FVGArrayRef[symbolIndex][0]=1;
       FVGArrayRef[symbolIndex][1]=FVG2;
     }     */
   ...
   /* if ( iClose(symbolName, PERIOD_M15, 1)< FVG4)
     {
       FVGArrayRef[symbolIndex][0]=-1;
       FVGArrayRef[symbolIndex][1]=FVG4;
     }  */ 
     }
