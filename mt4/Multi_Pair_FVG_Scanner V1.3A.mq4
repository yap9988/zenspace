...
//v1.3A contra 1.3 version, to see another side of signals
...
int stt=0;
      ...
      stt=stt1+stt2;
       ...
       //  string messageAlert=symbol+" FVG "+pType+". Entry is: "+DoubleToString(pEntry,(int)SymbolInfoInteger(symbol,SYMBOL_DIGITS))+". SL is: "+DoubleToString(pSL,(int)SymbolInfoInteger(symbol,SYMBOL_DIGITS))+". ";
         string messageAlert=symbol+" FVG(CONTRA) "+pType+". "+firstc+": "+firstS[symbolIndex][0]+st1+", "+lastc+": "+secondS[symbolIndex][0]+st2+". "+"Score: "+stt+". ";
