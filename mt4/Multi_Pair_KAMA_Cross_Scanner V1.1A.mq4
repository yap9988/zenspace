...
void calculatekama(ENUM_TIMEFRAMES timeFrame,double &FVGArrayRef[][],int symbolIndex,string symbolName)
 {
    ...
    */
    ...
    if (kamad3 == iHigh(symbolName, PERIOD_H1, 3) && kamau2 == iLow(symbolName, PERIOD_H1, 2) && kamau1 == iLow(symbolName, PERIOD_H1, 1))
    {
    ...
    if (kamau3 == iLow(symbolName, PERIOD_H1, 3) && kamad2 == iHigh(symbolName, PERIOD_H1, 2) && kamad1 == iHigh(symbolName, PERIOD_H1, 1))
    {
           FVGArrayRef[symbolIndex][0]=-1;
