...
int stt=0;
         ...
         pType = "^";
         currencystrength(pivotTimeframe,firstS,secondS,1,symbolIndex,symbol);
...
int stt=0;
      ...
      stt=stt1+stt2;
       ...
       //  string messageAlert=symbol+" FVG "+pType+". "+firstc+": "+firstS[symbolIndex][0]+st1+", "+lastc+": "+secondS[symbolIndex][0]+st2+". "+"Score: "+stt+". V: "+power+". "; last known good config
          ...
          string messageAlert=symbol+pType+"|S:"+stt+"|"+firstc+":"+firstS[symbolIndex][0]+st1+","+lastc+":"+secondS[symbolIndex][0]+st2+"|V:"+power;
...
void calculatekama(ENUM_TIMEFRAMES timeFrame,double &FVGArrayRef[][],int symbolIndex,string symbolName)
 {
   ...
   int nearestFVG3 = -1, nearestFVG4 = -1;
    ...
    if ( iClose(symbolName, PERIOD_M5, 1)> FVG1 )
     {
  ...
  /*  if ( iClose(symbolName, PERIOD_M15, 1)> FVG2)
    ...
    if ( iClose(symbolName, PERIOD_M5, 1)< FVG3 )
     {
       FVGArrayRef[symbolIndex][0]=-1;
...
void currencystrength(ENUM_TIMEFRAMES timeFrame,int &first[][],int &last[][],int bb,int symbolIndex,string symbolName)
 {
