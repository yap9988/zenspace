...
//v1.0 the first working version
...
int stt=0;
      ...
      stt=stt1+stt2;
       ...
       //  string messageAlert=symbol+" FVG "+pType+". "+firstc+": "+firstS[symbolIndex][0]+st1+", "+lastc+": "+secondS[symbolIndex][0]+st2+". "+"Score: "+stt+". V: "+power+". "; last known good config
          ...
          string messageAlert=symbol+pType+"(MA)|S:"+stt+"|"+firstc+":"+firstS[symbolIndex][0]+st1+","+lastc+":"+secondS[symbolIndex][0]+st2+"|V:"+power;
...
sma201h1=iMA(symbolName,PERIOD_H1,20,0,MODE_SMA, PRICE_CLOSE,1);
sma201h2=iMA(symbolName,PERIOD_H1,20,0,MODE_SMA, PRICE_CLOSE,2);
sma501h1=iMA(symbolName,PERIOD_H1,50,0,MODE_SMA, PRICE_CLOSE,1);
sma501h2=iMA(symbolName,PERIOD_H1,50,0,MODE_SMA, PRICE_CLOSE,2);
sma204h=iMA(symbolName,PERIOD_H4,20,0,MODE_SMA, PRICE_CLOSE,1);
sma504h=iMA(symbolName,PERIOD_H4,50,0,MODE_SMA, PRICE_CLOSE,1);



if (sma201h2 <sma501h2 && sma201h1>sma501h1)
{
if ( sma204h > sma504h)
{
