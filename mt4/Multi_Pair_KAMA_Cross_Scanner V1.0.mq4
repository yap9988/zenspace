...
int stt=0;
      ...
      stt=stt1+stt2;
       ...
       //  string messageAlert=symbol+" FVG "+pType+". "+firstc+": "+firstS[symbolIndex][0]+st1+", "+lastc+": "+secondS[symbolIndex][0]+st2+". "+"Score: "+stt+". V: "+power+". "; last known good config
          ...
          string messageAlert=symbol+pType+"(P)|S:"+stt+"|"+firstc+":"+firstS[symbolIndex][0]+st1+","+lastc+":"+secondS[symbolIndex][0]+st2+"|V:"+power;
...
void calculatekama(ENUM_TIMEFRAMES timeFrame,double &FVGArrayRef[][],int symbolIndex,string symbolName)
 {
   ...
   int nearestFVG3 = -1, nearestFVG4 = -1;
    ...
    //7 ExtUpFractalsBuffer[1] == Low[1]
     kamau1=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",7,1);
     kamau2=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",7,2);
     kamau3=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",7,3);
     kamad1=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",8,1);
     kamad2=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",8,2);
     kamad3=iCustom(symbolName,PERIOD_M15,"Limaocanfly\\KAMA V1.6",8,3);
    ...
    */
    ...
    if (kamad3 == iHigh(symbolName, PERIOD_M15, 3) && kamau2 == iLow(symbolName, PERIOD_M15, 2) && kamau1 == iLow(symbolName, PERIOD_M15, 1))
    {
           FVGArrayRef[symbolIndex][0]=1;
           FVGArrayRef[symbolIndex][1]=iLow(symbolName, PERIOD_M15, 1);
    }
    ...
    {
           FVGArrayRef[symbolIndex][0]=-1;
           FVGArrayRef[symbolIndex][1]=iHigh(symbolName, PERIOD_M15, 1);
    }
